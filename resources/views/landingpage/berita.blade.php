        ...
        <div class="container-fluid py-5  bg-pengalaman">
            <div class="container py-5">
                ...
                @foreach ($beritas as $berita)
                    <div class="blog-item">
                        <img src="images/berita/{{ $berita->gambar }}" class="img-fluid w-100 rounded-top" alt="">
                         <div class="rounded-bottom bg-light">
                            <div class="d-flex justify-content-between p-4 pb-2">
                                <span class="pe-2 text-dark"><i class="fa fa-user me-2"></i>By Admin</span>
                                <span class="text-dark"><i class="fas fa-calendar-alt me-2"></i>{{ $berita->created_at }}</span>
                            </div>
                            <div class="px-4 pb-0">
                                <h4>{{ $berita->judul }}</h4>
