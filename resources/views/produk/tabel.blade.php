        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-header pb-0 position-relative mb-5">
              <h6>Data Produk</h6>
              <a href="{{ url('admin/produk/tambah') }}" class="btn btn-success position-absolute end-0 top-0 mt-3 me-3">+ Produk</a>
            </div>
                  ...
                  <thead>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ url('admin/produk/ubah/'.$item['id']) }}" class="btn btn-sm btn-primary">Edit</a>
                            <a href="{{ url('admin/produk/hapus/'.$item['id']) }}" class="btn btn-sm btn-danger">Hapus</a>
                        </td>
                    </tr>
                    @endforeach
                    </tbody>
