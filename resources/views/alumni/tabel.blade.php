        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-header pb-0 position-relative mb-5">
              <h6>Data alumni</h6>
              <a href="{{ url('admin/alumni/tambah') }}" class="btn btn-success position-absolute end-0 top-0 mt-3 me-3">Tambah alumni</a>
            </div>
                ...
                <table class="table align-items-center mb-0" id="tabel-data">
                  <thead>
                    <tr>
                      ...
                      <th class="text-secondary">Satu</th>
                      <th class="text-secondary">Dua</th>
                      <th class="text-secondary">Tiga - Seblas</th>
                      <th class="text-secondary">Tiga Dua - Perkuliahan</th>
                    ...
                    <tbody>
                      ...
                      @foreach ($alumnis as $alumni)  
                        <tr>
                          ...
                          <td>{{ $alumni->duaA }}</td>
                          <td>{{ $alumni->seblas }}</td>
                          <td>{{ $alumni->tigabelasperkuliahan }}</td>
                          <td class="text-center">
                            <a href="{{ url('admin/alumni/ubah/'.$alumni->id) }}" class="btn btn-sm btn-primary">Edit</a>
                            <a href="{{ url('admin/alumni/hapus/'.$alumni->id) }}" class="btn btn-sm btn-danger">Hapus</a>
                          </td>
                        </tr>
                        <?php $no++; ?>
                      @endforeach
